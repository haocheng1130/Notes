...
v\in L^1(0,1),
$
the Lebesgue integral is absolutely continuous with respect to measure. That is, for every $\varepsilon>0$, there exists $\delta>0$ such that for every measurable set
$
E\subset (0,1),
$
if
...
u'(x)=0
$
for almost every $x\in I$, then $u$ is constant almost everywhere in $I$.
